...
const Avatar = ({ pic, displayName }) => {
  const randomName = () => {
    switch (pic) {
      case '':
        return avatar1;
      case '/images/avatar-01.png':
        return avatar1;
      case '/images/avatar-02.png':
        return avatar2;
      case '/images/avatar-03.png':
        return avatar3;
      case '/images/avatar-04.png':
        return avatar4;
      case '/images/avatar-05.png':
        return avatar5;
      case '/images/avatar-06.png':
        return avatar6;
      case '/images/avatar-07.png':
        return avatar7;
      case '/images/avatar-08.png':
        return avatar8;
      case '/images/avatar-09.png':
        return avatar9;
      case '/images/avatar-10.png':
        return avatar10;
      case 'juano':
        return juano;
      case 'flor':
  ...
  return (
    <div className="avatar">
      <img
        src={randomName()}
        alt={`${displayName}_devimg`}
        className="avatar-img glass-effect"
      />
